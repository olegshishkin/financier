...
func (_c *AccountStorage_Create_Call) RunAndReturn(run func(*domain.Account) error) *AccountStorage_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *AccountStorage_FindEnabledByName_Call) RunAndReturn(run func(string) (*domain.Account, error)) *AccountStorage_FindEnabledByName_Call {
	_c.Call.Return(run)
	return _c
}
